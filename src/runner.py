...
def mirror_into_repo(artifacts_dir: str | os.PathLike,
    ...
    source of truth; this keeps root results/<exp>/ and figures/<exp>/ pointing
    at the latest run so the tree a
...
def json_safe(value):
    ...
    legitimately infinite. Public because generated notebooks and scripts/
    serialise experiment configs too.
    """
