"""Experiment builders E1-E4: single source of truth used by the notebooks.
Each builder wires potential + jump law + box + init +
...
from .potentials import (CoupledPhi4, DoubleWell1D, MB3_CRITICAL,
                         ...
                         TransformedMB3Well10D,
                         mb3_2d, mb3_2d_grad, newton_refine,
                         phi4_W, phi4_W_grad)
