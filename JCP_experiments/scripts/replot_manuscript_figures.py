...
This script is deliberately narrower than ``replot_figures.py``:
...
EXPERIMENTS: dict[str, ExperimentSpec] = {
    "double_well": ExperimentSpec(
        display_name="E1: Double well",
        methods=("ULA", "BAOAB", "FLA", "PT", "CP", "LSC-CP", "LSC-CP-RA"),
        labels={
            "ULA": "ULA",
            "BAOAB": "ULD",
            "FLA": "FLA",
    ...
    "mog40": ExperimentSpec(
        display_name="E2: MoG40",
        methods=("ULA", "BAOAB", "FLA", "PT", "LSC-CP", "LSC-CP-RA"),
        labels={
            "ULA": "ULA",
            "BAOAB": "ULD",
            "FLA": "FLA",
    ...
    "mb3well_10d": ExperimentSpec(
        display_name=r"E3: M\"uller--Brown (10D)",
        methods=("ULA", "BAOAB", "FLA", "PT", "LSC-CP", "LSC-CP-MA"),
        labels={
            "ULA": "ULA",
            "BAOAB": "ULD",
            "FLA": "FLA",
    ...
    "coupled_phi4": ExperimentSpec(
        display_name=r"E4: Coupled $\phi^4$",
        methods=("ULA", "BAOAB", "FLA", "PT", "LSC-CP", "LSC-CP-MA"),
        labels={
            "ULA": "ULA",
            "BAOAB": "ULD",
...
def regenerate(
    ...
    *,
    ...
    png_outputs = sorted(png_dir.glob("*.png"))
    pdf_outputs = sorted(pdf_dir.glob("*.pdf"))
